...
<body class="login">
    <div class="login-container">
        <div class="login-header">
            ...
            <h1 class="login-title">Panel Profesor</h1>
            <p>Gestiona tus cursos y estudiantes</p>
        </div>

        <?php if (!empty($emailPrefill)): ?>
            <div style="background: #fff3e0; padding: 10px; border-radius: 5px; margin-bottom: 20px;">
        ...
        <form method="post" action="../backend/login.php">
            ...
            <button type="submit" class="login-btn">📚 Ingresar como Profesor</button>
        </form>
        ...
        <div class="login-links">
            <a href="alumno_login.php">🎓 Soy Alumno</a>
